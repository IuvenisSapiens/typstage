...
#let runtime-words(lang) = {
  let listen = (
    de: (no-note: "keine Notiz",
         ...
         help-speaker: "Blättern: ← →|Folie · ↑ ↓|Notiz rollen · Pos1|zum Anfang · Ende|zum Schluss · o|Übersicht § Saal: b|schwarz · e|einfrieren · n|Vortrag nach vorn § Zeit: 1–9|Minuten als Uhr · 0|Uhr aus · t|Klassenuhr · ⇧t|Uhr auf der Folie · ⇧← ⇧→|eine Minute · d|Zieldauer · r|Stundenzähler zurück § Zeichnen: m|Stift/Zeiger · c|Farbe · z|Strich zurück · x|Folie löschen § Ansicht: l|hell/dunkel · + −|Notizgröße · f|Vollbild · ?|alle Tasten",
